...
class ElementSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('elements')->insert([
            ...
            /* "type" => "buttonLarge",
            "content" => "\" <button class='btn-success form-control'>Button</button> \" ",*/
            'active' => true,
        ]);
