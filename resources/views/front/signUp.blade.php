              ...
              <div class="w-100 py-5 px-md-5 px-xl-6 position-relative">
                ...
                <form class="form-validate" action="{{ route('register') }}" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input name="firstname" id="firstname" type="text" placeholder="Mike" autocomplete="off" required="" data-msg="Please enter your email" class="form-control">
                  </div>
                  <div class="form-group">
                    <label for="lastname" class="form-label"> Lastname</label>
                    <input name="lastname" id="lastname" type="text" placeholder="Perez" autocomplete="off" required="" data-msg="Please enter your email" class="form-control">
                  </div>
                  <div class="form-group">
